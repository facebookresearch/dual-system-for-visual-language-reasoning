...
Header: Entity | Value
Row 1: Minor/not threat | 17.0
Row 2: Very/ somewhat serious threat | 76.0
Row 3: Don't know | 7.0
Q: What is the ratio between Very/ somewhat serious threat and Don't know in the chart?
A: Let's extract the numbers of Very/ somewhat serious threat and Don't know. They are 76.0 and 17.0. 76.0/7.0=10.86. The answer is 10.86.
...
Header: Characteristic | Not at all | 1 time | 2-3 times | 4 times or more
Row 1: Visit close friends or family | 70% | 18% | 9% | 3%
Row 2: Go to work | 67% | 4% | 7% | 22%
Row 3: Exercise | 57% | 7% | 18% | 18%
Row 4: Shop for food, medicine or essential household items | 20% | 36% | 36% | 8%
Q: What is the highest value for Not at all?
A: Let's find the column of Not al all. Then let's extract the values: [70%, 67%, 57%, 20%]. The highest value is 70%. The answer is 70%.
