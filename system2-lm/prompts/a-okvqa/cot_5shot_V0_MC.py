...
(c) to pet
(d) to comb
A: Let's find out what is the person holding.
Food.
...
(c) swimming
(d) surfing
A: Let's find out where are the people.
Above sea.
...
(c) duet
(d) sextet
A: Let's find out how many people are performing on the stage.
4.
...
(c) two 
(d) four
A: Let's find out what food items are there.
Salad, bread.
...
(c) order number
(d) price
A: Let's find out what is this place.
Restaurant.
