...
table_paths=("${home_dir}/chart2table/outputs/figureQA-val1_sample5K/google/deplot_vqa/inference_split0-1.jsonl" "${home_dir}/chart2table/outputs/figureQA-val2_sample5K/google/deplot_vqa/inference_split0-1.jsonl")
...
do
    ...
    do
        ...
        table_path=${table_paths[split_idx]}
